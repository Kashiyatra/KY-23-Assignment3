...
const KashiNight = () => {
  return (
   <div className="nightSection">
     <Fade top> <h2>Kasshiyatra 2023</h2></Fade> 
    {/* <div className="night mt-6 mb-6 " >
...
const Wrapper = styled.div`
  ...
  background-image: url("../data/kashi-night-pic.png");
